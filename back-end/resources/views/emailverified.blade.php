...
<div class="container">
	<div class="left-section">
		<div class="inner-content">
            <img class="logo" src="https://lh5.googleusercontent.com/MJYb9efvADYjWrfcJXNMvkvHGRWc0pgbHZcO8F8uEgrkLjHgXDNna6pH334yIChJA4I=w1200-h630-p">
			<h1 class="heading">Account Verified</h1>
			<p class="subheading">Login to yukgym app for healty life</p>
            <p class="subheading">Enjoy  ୧(▲ᴗ▲)ノ</p>
        </div>
	</div>

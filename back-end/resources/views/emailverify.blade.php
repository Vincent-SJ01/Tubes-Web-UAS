...
<div class="container">
	<div class="left-section">
		<div class="inner-content">
			<h1 class="heading">Verify success</h1>
			<p class="subheading">Thank you for being member of yukgym</p>
            <p class="subheading">enjoy  ୧(▲ᴗ▲)ノ</p>
        </div>
	</div>
	<div class="right-section">
        <img src="blob:https://studentsuajyac-my.sharepoint.com/e0d2f1ab-5248-4da4-9a80-d48bc7c01cf1" alt="yukgym">
